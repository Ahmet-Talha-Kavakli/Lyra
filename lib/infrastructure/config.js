...
export const config = {
    ...
    // Database (Connection Pooling for Vercel Serverless)
    DATABASE_URL:         process.env.DATABASE_URL || null,
    DATABASE_POOLER_URL:  process.env.DATABASE_POOLER_URL || null,
    DB_POOL_SIZE:         process.env.DB_POOL_SIZE || '20',
    DB_IDLE_TIMEOUT:      process.env.DB_IDLE_TIMEOUT || '15000',
    DB_CONNECTION_TIMEOUT: process.env.DB_CONNECTION_TIMEOUT || '5000',
    DB_STATEMENT_TIMEOUT: process.env.DB_STATEMENT_TIMEOUT || '30000',
    ...
    // Queue (Upstash QStash for Vercel Serverless)
    QSTASH_TOKEN:         process.env.QSTASH_TOKEN || null,
